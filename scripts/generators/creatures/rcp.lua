...
local function quadruped_function_curry(is_grasp) -- thank you lua (or maybe don't?)
	...
	return function(rcp,options)
		...
		if not options.tweak and not rcp.cannot_have_get_more_legs and one_in(20) then
			if one_in(2) then
				options.tweak="EIGHT_LEGGED"
				table_merge(bp,{first_leg,"RCP_SECOND_SIMPLE_LEGS","RCP_THIRD_SIMPLE_LEGS","RCP_FOURTH_SIMPLE_LEGS"})
			else
				options.tweak="SIX_LEGGED"
...
pcg_layering_base_info={
	...
	BEAST_SNAKE={shell_pos="BACK"},
	BEAST_WORM_LONG={shell_pos="BACK"},
	BEAST_WORM_SHORT={shell_pos="BACK"},
	BEAST_INSECT={shell_pos="BACK"},
	BEAST_SPIDER={shell_pos="FRONT"},
	BEAST_SCORPION={tail=true,shell_pos="FRONT"},
	BEAST_BIPEDAL_DINOSAUR={tail=true,shell_pos="BACK"},
	BEAST_HUMANOID={tail=true,shell_pos="BACK"},
	BEAST_FRONT_GRASP={tail=true,shell_pos="BACK"},
	BEAST_QUADRUPED_BULKY={tail=true,shell_pos="FRONT"},
	BEAST_QUADRUPED_SLINKY={tail=true,shell_pos="FRONT"},
	BEAST_WALRUS={tail=true,shell_pos="BACK"},
}
